			...
			<table class="table table-bordered table-hover"
				...
				<tbody>
					<tr>
						...
						<td><input class="form-control" type="email" id="userID"
							name="userID" maxlength="20" placeholder="이메일을 입력해 주세요."></td>
						<td style="width: 110;"><button class="btn btn-primary"
					...
					<tr>
						...
						<td colspan="2"><input class="form-control" type="password"
							...
							onkeyup="passwordCheckFunction();" placeholder="비밀번호를 입력해 주세요."></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2"><input class="form-control" type="text"
							id="userBirthdate" name="userBirthdate" maxlength="20"
							placeholder="나이를 입력해 주세요."></td>
					</tr>
					<tr>
