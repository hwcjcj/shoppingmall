	...
	<div class="container-fluid text-center">
		<div class="row content">
			...
			<div class="col-sm-8 text-left">
				<div class="container">
					<div class="row">
						<form method="post" action="../UploadQna.do">
							<table class="table table-striped"
								style="text-align: center; border: 1px solid #dddddd;">
								<thead>
									<tr>
										<th colspan="2"
											style="backgroud-color: #eeeeee; text-align: center;">질문
											작성</th>
									</tr>
								</thead>
								<tbody>
									<tr>
										<td>제목</td>
										<td><input type="text" class="form-control" name="qtitle"
											maxlength="50"></td>
									</tr>
									<tr>
										<td>내용</td>
										<td><textarea class="form-control" placeholder="글 내용"
												name="qtext" maxlength="2048" style="height: 350px;"></textarea></td>
									</tr>
								</tbody>
							</table>
