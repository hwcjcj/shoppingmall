...
$(document).ready(function() {
	...
	$("#othr").click(function() {
		$("#categoryDiv").html('<select name="category">'
				...
				+'<option value="othr4">일렉트로닉</option>'
...
<body>
	<%
		...
		Product p = product.getProductDetail(pid);
		int idx = p.getAlbumImage().indexOf("images/");
		String src ="/ordersystem/" + p.getAlbumImage().substring(idx);
	%>
							...
							<tbody>
								<tr>
									...
									<td><input class="form-control" type="text"
										name="albumName" value="<%=p.getAlbumName()%>"></td>
								</tr>
								<tr>
									<td>가수명</td>
									<td><input class="form-control" type="text" name="artist"
										value="<%=p.getArtist()%>"></td>
								</tr>
								<tr>
									<td>장르</td>
								...
								<tr>
									<td>장르2(종류를 텍스트로)</td>
									<td><input class="form-control" type="text" name="genre2" 
										value="<%=p.getGenre2()%>"></td>
								</tr>
								<tr>
									<td>카테고리 분류</td>
									<td><b><%=p.getCountry() %>,&emsp;<%=p.getCategory()%></b>&emsp;
										<input type="radio" id="kor" name="country" value="국내">국내 
								...
								<tr>
									<td>앨범이미지</td>
									<td><input type="file" name="albumImage"> <img
										src="<%=src%>" height="250px"></td>
								</tr>
								<tr>
									<td>수량</td>
									<td><input class="form-control" type="text"
										name="quantity" value="<%=p.getQuantity()%>"></td>
								</tr>
								<tr>
									<td>앨범정보</td>
									<td><textarea class="form-control" name="albumInfo"
											maxlength="2048" style="height: 350px;"><%=p.getAlbumInfo()%></textarea>
								<input type="hidden" name="pid" value="<%=p.getPid()%>"></td>
								</tr>
							</tbody>
						</table>
